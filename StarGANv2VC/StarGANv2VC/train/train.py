                    ...
                    if i < len_list_sample:
                        if j == list_index_sample[i][0]:
                            if count_sample < len_list_first_sample:
                                ...
                                spe_input_j = destandardizer(spe_input[list_index_sample[i][1]].squeeze(0))
